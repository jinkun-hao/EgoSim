...
from egosim_state.ext.specs import get_cpp_flags, get_cuda_flags, get_sources


try:
    import egosim_state_ext as _C

    egosim_state_ext_not_found = False
except ImportError:
    egosim_state_ext_not_found = True

if egosim_state_ext_not_found or os.environ.get("EGOSIM_STATE_EXT_JIT", "0") == "1":
    _C = load(
        name="egosim_state_ext_jit",
        sources=get_sources(),
