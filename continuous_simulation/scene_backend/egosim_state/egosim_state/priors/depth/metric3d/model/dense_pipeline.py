...
class DensePredModel(nn.Module):
    def __init__(self, cfg) -> None:
        ...
        self.encoder = get_func(
            "egosim_state.priors.depth.metric3d.model." + cfg.model.backbone.prefix + cfg.model.backbone.type
        )(**cfg.model.backbone)
        self.decoder = get_func(
            "egosim_state.priors.depth.metric3d.model." + cfg.model.decode_head.prefix + cfg.model.decode_head.type
        )(cfg)
