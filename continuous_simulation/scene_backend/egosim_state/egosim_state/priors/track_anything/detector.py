...
from egosim_state.utils.model_paths import get_grounding_dino_checkpoint_path
...
class Detector:
    def __init__(self, device):
        ...
        #     map_location="cpu",
        # )
        checkpoint = torch.load(str(get_grounding_dino_checkpoint_path()), map_location="cpu")
