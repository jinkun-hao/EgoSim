...
from egosim_state.ext import droid_net_ext
from egosim_state.ext.scatter import scatter_mean
from egosim_state.utils.model_paths import get_droid_checkpoint_path
...
class DroidNet(nn.Module):
    ...
    def load_weights(self):
        ...
        ckpt_path = get_droid_checkpoint_path()
