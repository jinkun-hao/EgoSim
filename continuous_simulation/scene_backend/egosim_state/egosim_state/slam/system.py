...
from egosim_state.priors.depth import make_depth_model
from egosim_state.priors.depth.adapter import PinholeDepthAdapter
from egosim_state.priors.depth.base import DepthType
from egosim_state.streams.base import (FrameAttribute, ProcessedVideoStream,
...
class SLAMSystem:
    ...
    def run(
        ...
        if self.visualize:
            rr.init("EgoSim State Visualization", spawn=True, recording_id=uuid.uuid4())
