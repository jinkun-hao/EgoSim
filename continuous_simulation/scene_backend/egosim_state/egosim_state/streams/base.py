...
class VideoFrame:
    ...
    interactive_obj_ids: set[int] | None = None  # Object IDs that are interactive (high IoU with hand)
    mask: torch.Tensor | None = None
    metric_depth: torch.Tensor | None = None
    depth_scale: float | None = None  # Depth scale factor for SLAM alignment
    information: str = ""
